 ...
 */
class Version20180216202042 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE AuthCode (id INT AUTO_INCREMENT NOT NULL, redirectUri VARCHAR(255) DEFAULT NULL, expiryDateTime DATE DEFAULT NULL, identifier LONGTEXT NOT NULL, client INT DEFAULT NULL, UNIQUE INDEX UNIQ_F1D7D177C7440455 (client), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
