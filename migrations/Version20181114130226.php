 ...
 */
class Version20181114130226 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE RefreshToken (identifier VARCHAR(40) NOT NULL, expiryDateTime DATE DEFAULT NULL, revoked TINYINT(1) NOT NULL, accessToken VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_7142379E350A9822 (accessToken), PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Scope (identifier VARCHAR(40) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE AccessToken (identifier VARCHAR(255) NOT NULL, client INT DEFAULT NULL, expiryDateTime DATE DEFAULT NULL, userIdentifier INT DEFAULT NULL, revoked TINYINT(1) NOT NULL, INDEX IDX_B39617F5C7440455 (client), PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE AccessToken_Scope (token_id VARCHAR(255) NOT NULL, scope_id VARCHAR(40) NOT NULL, INDEX IDX_83FAAB4241DEE7B9 (token_id), INDEX IDX_83FAAB42682B5931 (scope_id), PRIMARY KEY(token_id, scope_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
