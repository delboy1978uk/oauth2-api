...
class Version20181119121841 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `Client` (`id`, `user_id`, `name`, `description`, `icon`, `grantType`, `redirectUri`, `identifier`, `secret`, `confidential`) VALUES (2, 1, 'testclient', 'iPhone App client', 'https://awesome.scot/img/emails/logo.jpg', 'code', '/fake-client-callback', '83c44d2a7b80fff51591478a4936fa7d', NULL, 0);");
