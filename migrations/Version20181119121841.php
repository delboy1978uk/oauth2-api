...
class Version20181119121841 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `Client` (`id`, `user_id`, `name`, `description`, `icon`, `grantType`, `redirectUri`, `identifier`, `secret`, `confidential`) VALUES (1, 1, 'BoneMVC App', 'Official first party web client', 'https://awesome.scot/img/emails/logo.jpg', 'client_credentials', 'https://awesome.scot/fake-client-callback', 'ceac682a9a4808bf910ad49134230e0e', 'JDJ5JDEwJGNEd1J1VEdOY0YxS3QvL0pWQzMxay52', 1);");
        $this->addSql("INSERT INTO `Client` (`id`, `user_id`, `name`, `description`, `icon`, `grantType`, `redirectUri`, `identifier`, `secret`, `confidential`) VALUES (2, 1, 'Web App', 'Web App client using auth code grant', 'https://awesome.scot/img/emails/logo.jpg', 'code', '/fake-client-callback', '83c44d2a7b80fff51591478a4936fa7d', NULL, 0);");
        $this->addSql("INSERT INTO `Client` (`id`, `user_id`, `name`, `description`, `icon`, `grantType`, `redirectUri`, `identifier`, `secret`, `confidential`) VALUES (3, 1, 'iPhone App', 'Official iPhone app', 'https://awesome.scot/img/emails/logo.jpg', 'password', '/fake-client-callback', 'e8041ed18678d963428eda7645b5367d', 'JDJ5JDEwJDZmQzB6NDYvQ2R6VzF2Qi5NVnhqUnVZ', 1);");
        ...
        $this->addSql('INSERT INTO `Client_Scope` (`client_id`, `scope_id`) VALUES (3, 2);');
    }
